...
public class GridViewAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.image_view = (ImageView) row.findViewById(io.github.xueluwu.android.organizeyourcloset.R.id.image_view);
            row.setTag(holder);
        } else {
        ...
        if (position == mSelectedPosition)
            ...
            holder.image_view.setBackgroundColor(context.getResources().getColor(R.color.colorPrimaryLightest));
